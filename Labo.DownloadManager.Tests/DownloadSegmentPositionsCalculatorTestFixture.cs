...
namespace Labo.DownloadManager.Tests
{
    ...
    public class DownloadSegmentPositionsCalculatorTestFixture
    {
        public static object[] CalculateTestCases =
            {
                new object[] {200, 5, 5, 200,  new []{ new DownloadSegmentPositions{ StartPosition = 0,   EndPosition = 200 } }},
                new object[] {200, 5, 5, 150,  new []{ new DownloadSegmentPositions{ StartPosition = 0,   EndPosition = 150 } }},
                new object[] {200, 1, 1, 150,  new []{ new DownloadSegmentPositions{ StartPosition = 0,   EndPosition = 150 } }},
                new object[] {200, 4, 1, 200,  new []{ new DownloadSegmentPositions{ StartPosition = 0,   EndPosition = 200 } }},
                new object[] {200, 5, 1, 250,  new []{ new DownloadSegmentPositions{ StartPosition = 0,   EndPosition = 250 } }},
                new object[] {200, 5, 5, 1000, new []{ new DownloadSegmentPositions{ StartPosition = 0,   EndPosition = 200 }, 
                                                       ...
                                                       new DownloadSegmentPositions{ StartPosition = 800, EndPosition = 1000 } }},
                new object[] {200, 5, 4, 1000, new []{ new DownloadSegmentPositions{ StartPosition = 0,   EndPosition = 250 }, 
                                                       ...
                                                       new DownloadSegmentPositions{ StartPosition = 750, EndPosition = 1000 } }},
                new object[] {200, 5, 1, 1000, new []{ new DownloadSegmentPositions{ StartPosition = 0,   EndPosition = 1000 }}},
                new object[] {200, 5, 6, 1000, new []{ new DownloadSegmentPositions{ StartPosition = 0,   EndPosition = 200 }, 
                                                       new DownloadSegmentPositions{ StartPosition = 200, EndPosition = 400 }, 
                                                       new DownloadSegmentPositions{ StartPosition = 400, EndPosition = 600 }, 
                                                       new DownloadSegmentPositions{ StartPosition = 600, EndPosition = 800 },
                                                       new DownloadSegmentPositions{ StartPosition = 800, EndPosition = 1000 } }},
                new object[] {200, 5, 6, 1004, new []{ new DownloadSegmentPositions{ StartPosition = 0,   EndPosition = 200 }, 
                                                       ...
                                                       new DownloadSegmentPositions{ StartPosition = 400, EndPosition = 600 }, 
                                                       new DownloadSegmentPositions{ StartPosition = 600, EndPosition = 800 },
                                                       new DownloadSegmentPositions{ StartPosition = 800, EndPosition = 1004 } }}
            };
